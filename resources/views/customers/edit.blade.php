                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            @if($customer->profile_image)
                                <div class="mb-3 flex items-center gap-3">
                                    <img src="{{ asset('storage/' . $customer->profile_image) }}"
                                         alt="{{ $customer->name }}"
                                         class="w-16 h-16 rounded-full object-cover ring-2 ring-indigo-500 shadow-sm">
                            ...
                            <div class="relative">
                                ...
                                <label for="profile_image"
                                       class="flex items-center justify-center w-full border-2 border-dashed @error('profile_image') border-red-500 @else border-gray-300 hover:border-indigo-500 @enderror rounded-lg px-4 py-3 cursor-pointer transition duration-200 hover:bg-indigo-50">
                            ...
                            <div id="image_preview" class="mt-2 hidden">
                                <img src="" alt="Preview" class="w-20 h-20 rounded-lg object-cover shadow-md">
                            </div>
                            @error('profile_image')
                                <p class="text-red-500 text-xs mt-1 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="address" rows="4"
                                      ...
                                      class="w-full border-2 @error('address') border-red-500 @else border-gray-300 focus:border-indigo-500 @enderror rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-200 transition duration-200">{{ old('address', $customer->address) }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-xs mt-1 flex items-center">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                        ...
                        <a href="{{ route('customers.index') }}"
                           class="flex-1 inline-flex justify-center items-center px-6 py-3
                                  ...
                                  rounded-xl shadow-lg transition duration-300 transform hover:scale-105">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
