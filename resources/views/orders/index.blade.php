<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            ...
            <a href="{{ route('orders.create') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold rounded-xl shadow-lg transition duration-300 transform hover:scale-105">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-5 border-b border-gray-200">
                    <div class="flex flex-col md:flex-row md:justify-between gap-4">
                        ...
                        <form method="GET" action="{{ route('orders.index') }}" class="flex gap-2 flex-wrap">
                            <select name="status" class="border-2 border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-200">
                            ...
                            <button type="submit" class="px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg shadow-md transition duration-300 transform hover:scale-105">
                            ...
                            @if(request('status'))
                                <a href="{{ route('orders.index') }}" class="px-6 py-2.5 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold rounded-lg shadow-md transition duration-300">
                                    Clear Filter
                                </a>
                            @endif
                        </form>
                        ...
                        <div class="flex gap-3">
                            <a href="{{ route('orders.export', array_merge(['format' => 'csv'], request()->all())) }}" 
                            ...
                            <a href="{{ route('orders.export', array_merge(['format' => 'pdf'], request()->all())) }}" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($orders as $order)
                                <tr class="hover:bg-green-50 transition duration-200">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-12 w-12 bg-gradient-to-br from-green-400 to-green-600 rounded-lg flex items-center justify-center shadow-md">
                                        ...
                                        <div class="flex items-center">
                                            @if($order->customer->profile_image)
                                                <img src="{{ asset('storage/' . $order->customer->profile_image) }}" 
                                                     ...
                                                     class="w-10 h-10 rounded-full object-cover ring-2 ring-green-500 shadow-md">
                                            @else
                                                <div class="w-10 h-10 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center text-white font-bold text-sm ring-2 ring-green-500 shadow-md">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-lg font-bold text-gray-900">₹{{ number_format($order->amount, 2) }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        ...
                                        <a href="{{ route('orders.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition duration-300">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                            </svg>
                                            Create Order
